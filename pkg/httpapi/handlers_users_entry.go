...
func userHandleCreate(w http.ResponseWriter, r *http.Request)                { userCreateHandler(w, r) }
...
func userHandleAuthVerifyPassword(w http.ResponseWriter, r *http.Request)     { userAuthVerifyPasswordHandler(w, r) }
